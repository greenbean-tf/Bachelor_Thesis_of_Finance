...
def timer(i, data_size, start, precision=100):
    if i == 0:
        cond1 = False
...
if __name__ == '__main__':
    To, expected_return = find_opt_open_threshold(1, -0.07143314, -0.23880371,
                                                        -0.07143314, 1, 0.84195924,
                                                        -0.23880371, 0.84195924, 1,
                                                        2.4237537, 0.9320864, 3.8338094, 2.106056 , 3.336428 , 3.4123316,
                                                        1.21123,
                                                        mode="Gumbel", adj=False,
                                                        opt_grain=100,
                                                        integral_grain=10,
                                                        early_stop=5)
    print(To, expected_return*468.25*0.0012384103495794)
    r=[]
    for x in np.linspace(0,10,1000):
        r.append(expect_profit_Gumbel_integral(x,
                                      1, -0.07143314, -0.23880371,
                                      -0.07143314, 1, 0.84195924,
                                      -0.23880371, 0.84195924, 1,
                                      2.6260245, 0.9922263, 3.7240674, 1.584342, 2.7797012, 2.5540311,
                                      2.48803742335552,
                                      False,
                                      grain=10))
    plt.plot(r)
